    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 font-inter">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-blue-400 to-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-br from-pink-400 to-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
          ...
          <div className="text-center">
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg mb-8 animate-fade-in">
              ...
              <span className="text-sm font-medium text-gray-700">
                AI-Powered Website Prompt Generator
              </span>
            </div>

            <h1
              className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight animate-fade-in"
            ...
            >
              Transform your ideas into detailed, professional prompts that AI
              website builders understand perfectly. No technical knowledge
              required.
            </p>
            <div
            ...
            >
              <Button
                asChild
                size="lg"
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-6 text-lg hover-scale"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get professional results without the complexity. Our tool guides
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center p-8 border-2 hover:border-purple-200 transition-all duration-300 hover-scale">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Get intelligent recommendations based on your business type
                  and goals. Our AI understands what works.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-8 border-2 hover:border-purple-200 transition-all duration-300 hover-scale">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Create comprehensive website prompts in minutes, not hours.
            ...
            <Card className="text-center p-8 border-2 hover:border-purple-200 transition-all duration-300 hover-scale">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Tailor your prompts to your exact audience and business needs
                  with our guided approach.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Tell us about your business, target audience, and what you want
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Our AI analyzes your requirements and suggests features, pages,
                and design styles.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Get your optimized prompt and use it with any AI website builder
                for perfect results.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p
            className="text-xl text-purple-100 mb-8 leading-relaxed animate-fade-in"
            style={{ animationDelay: "0.2s" }}
          >
            Join thousands of satisfied users who have transformed their web
            development process
          </p>
          <Button
            asChild
            size="lg"
            variant="secondary"
            className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-6 text-lg hover-scale animate-fade-in"
            style={{ animationDelay: "0.4s" }}
          >
            <Link to="/prompt-builder">
      ...
      {/* Feedback Section */}
      <section className="w-full flex flex-col items-center py-12 bg-white border-t mt-8">
        <h2 className="text-2xl font-semibold mb-4 text-gray-900">
          We value your feedback!
        </h2>
        <p className="mb-6 text-gray-600 text-center max-w-xl">
          Help us improve Prompt4U by sharing your thoughts, suggestions, or
          issues. Your feedback makes a difference!
        </p>
        <a
          href="https://docs.google.com/forms/d/e/1FAIpQLScXM914p3n2r1lVodwLUaJNdtKvWxO0yb2CukhfuyMMI0qv7g/viewform?usp=header"
          target="_blank"
        ...
        >
          <Button
            size="lg"
            variant="primary"
            className="px-8 py-4 text-lg rounded-full shadow-md hover:bg-purple-700 transition-colors"
          >
            Submit Feedback
          </Button>
        </a>
